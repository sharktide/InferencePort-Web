...
for f in index.html pricing.html lightning.html marketplace.html redirect.html solutions.html seniorband.html tools.html security.html shield.html install.html reset.html openapp.html authcallback.html robots.txt sitemap.xml CNAME LICENSE icon.png; do
  [ -f "$f" ] && cp "$f" dist/
done
